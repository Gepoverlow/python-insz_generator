...
def handle_bis_generation(is_gender_known, is_birthday_known, date, amount) -> list[str]:
...
def generate_bis():
    while True:
        try:
            is_gender_known: bool = handle_bis_is_gender_known_input()
            is_birthday_known: bool = handle_bis_is_birthday_known_input()
            date: str = handle_date_input()
            amount: str = handle_amount_input()

            bis_results: list[str] = handle_bis_generation(is_gender_known, is_birthday_known, date, amount)
