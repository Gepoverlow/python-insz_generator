...
class TestInszGeneration(unittest.TestCase):
    ...
    def test_insz_generation_amount_one_gender_unisex(self):
        result: list[str] = i.handle_insz_generation('12/12/2012', 1, 'u')
        self.assertEqual(len(result), 1)

        for j in result:
            self.assertTrue(u.is_valid_insz(j))

    def test_insz_generation_amount_multiple_gender_unisex(self):
        result: list[str] = i.handle_insz_generation('12/12/2012', 5, 'u')
    ...
    def test_insz_generation_amount_one_gender_man(self):
        result: list[str] = i.handle_insz_generation('12/12/2012', 1, 'm')
        self.assertEqual(len(result), 1)
    ...
    def test_insz_generation_amount_multiple_gender_man(self):
        result: list[str] = i.handle_insz_generation('12/12/2012', 5, 'm')
        self.assertEqual(len(result), 5)
    ...
    def test_insz_generation_amount_one_gender_woman(self):
        result: list[str] = i.handle_insz_generation('12/12/2012', 1, 'w')
        self.assertEqual(len(result), 1)
    ...
    def test_insz_generation_amount_multiple_gender_woman(self):
        result: list[str] = i.handle_insz_generation('12/12/2012', 5, 'w')
        self.assertEqual(len(result), 5)
    ...
    def test_insz_decodification_pre_2000_date_man(self):
        ...
        detected_gender: str = u.detect_insz_gender(insz_nr)
        result: str = i.handle_insz_decodification(insz_nr, False, detected_gender)
    ...
    def test_insz_decodification_post_2000_date_man(self):
        ...
        detected_gender: str = u.detect_insz_gender(insz_nr)
        result: str = i.handle_insz_decodification(insz_nr, True, detected_gender)
