...
class TestUtilityValidation(unittest.TestCase):
    ...
    def test_valid_gender(self):
        ...
        result: bool = util.is_gender_valid(gender_input)
    ...
    def test_invalid_amount(self, mock_stdout):
        ...
        util.is_amount_valid(amount_input)
    ...
    def test_valid_yes_or_no(self):
        ...
        result: bool = util.is_yes_or_no_valid(yes_or_no_input)
    ...
    def test_invalid_yes_or_no(self, mock_stdout):
        ...
        util.is_yes_or_no_valid(yes_or_no_input)
    ...
    def test_valid_insz(self):
        ...
        result: bool = util.is_insz_valid(insz_input)
